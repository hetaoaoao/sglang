...
def maybe_register_hicache_draft(
    *,
    ...
    elif isinstance(pool, DSATokenToKVPool):
        draft_host_pool = MLATokenToKVPoolHost(pool, **kw, override_kv_cache_dim=pool.kv_cache_dim)
    ...
    tree_cache.cache_controller.set_draft_kv_pool(pool, draft_host_pool, draft_indexer_host_pool)
